    ...
    <main class="content">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
            <div class="d-block mb-4 mb-md-0">
                ...
                <p class="mb-0">All students in the system.</p>
            </div>
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="add-student.php" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="border-gray-200">Paid Fees</th>
                        <th class="border-gray-200">Update Fees</th>
                    </tr>
                </thead>
                <tbody>
                    <!-- Item -->
                    <tr>
                        ...
                        <td class="position-relative"><span class="fw-bold text-warning element-inside-td">No</span></td>
                        <td class="position-relative">
                            <button class="btn btn-info btn-in-td" type="button" id="update-student-fee">Update</button>
                        </td>
                    </tr>
                    <!-- Item -->
                    <tr>
