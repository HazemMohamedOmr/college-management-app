...
<!-- Primary Meta Tags -->
<title>Learnigo || Add Student</title>
    ...
    <main class="content">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
            <div class="d-block mb-4 mb-md-0">
                ...
                <p class="mb-0">Add new student for the college in the system.</p>
            </div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            ...
                            <input class="form-control" id="level" name="level" type="number" placeholder="Enter level" required>
                        </div>
                    </div>
                </div>
