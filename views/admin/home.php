        ...
        <div class="py-4">
            <div class="dropdown">
                ...
                <div class="dropdown-menu dashboard-dropdown dropdown-menu-start mt-2 py-1">
                    <a class="dropdown-item d-flex align-items-center" href="add-teacher.php">
                    ...
                    <a class="dropdown-item d-flex align-items-center" href="add-student.php">
                    ...
                    <a class="dropdown-item d-flex align-items-center" href="add-librarian.php">
                    ...
                    <a class="dropdown-item d-flex align-items-center" href="add-timetable.php">
                        <svg class="dropdown-icon text-gray-400 me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                        Add TimeTable
                    </a>
                    <a class="dropdown-item d-flex align-items-center" href="add-fee.php">
                        <svg class="dropdown-icon text-gray-400 me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M2.166 4.999A11.954 11.954 0 0010 1.944 11.954 11.954 0 0017.834 5c.11.65.166 1.32.166 2.001 0 5.225-3.34 9.67-8 11.317C5.34 16.67 2 12.225 2 7c0-.682.057-1.35.166-2.001zm11.541 3.708a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"></path></svg>
                        Add Fee
                    </a>
                    <a class="dropdown-item d-flex align-items-center" href="add-event.php">
                        ...
                        <div class="row">
                            <div class="col-md-8 offset-2">
                                <blockquote class="blockquote text-center">
                                    ...
                                    <footer class="blockquote-footer mt-3 text-primary">Calvin Coolidge</footer>
                                </blockquote>
                            </div>
                        </div>
                    </div>
