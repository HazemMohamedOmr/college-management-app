...
<!-- Primary Meta Tags -->
<title>Learnigo || Add Librarian</title>
    ...
    <main class="content">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
            <div class="d-block mb-4 mb-md-0">
                <h2 class="h4">Add New Librarians</h2>
                <p class="mb-0">Add new librarian for the college in the system.</p>
            </div>
        </div>
        ...
        <div class="card card-body border-0 shadow mb-4">
            ...
            <form action="#" method="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="form-group">
                            <label for="ldegree">Librarian Degree</label>
                            <input class="form-control" id="ldegree" name="ldegree" type="number" placeholder="Enter librarian degree" required>
                        </div>
                    </div>
                </div>
