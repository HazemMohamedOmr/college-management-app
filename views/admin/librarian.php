...
<!-- Primary Meta Tags -->
<title>Learnigo || Librarians</title>
    ...
    <main class="content">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
            <div class="d-block mb-4 mb-md-0">
                ...
                <p class="mb-0">All librarians in the system.</p>
            </div>
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="add-librarian.php" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="border-gray-200">L-Degree</th>
                    </tr>
                </thead>
                <tbody>
                    <!-- Item -->
