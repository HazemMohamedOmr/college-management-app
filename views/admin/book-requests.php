...
<!-- Primary Meta Tags -->
<title>Learnigo || Book Requests</title>
    ...
    <main class="content">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
            <div class="d-block mb-4 mb-md-0">
                ...
                <h2 class="h4">All Book Requests</h2>
                <p class="mb-0">All book requests in the system.</p>
            </div>
        </div>
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="border-gray-200">Book name</th>
                        <th class="border-gray-200">Duration</th>
                        <th class="border-gray-200">Book avaliable quantity</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="position-relative">
                            <button class="btn btn btn-danger btn-in-td" type="button" id="delete-book-request">Delete</button>
                            <!-- <div class="btn-group">
