...
<?php
    ...
    $colleges = $superadmin->viewCollege();
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="d-block mb-4 mb-md-0">
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                    <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                        ...
                        <li class="breadcrumb-item"><a href="home.php">Super-Admin</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Colleges</li>
                    </ol>
                </nav>
                <h2 class="h4">All Colleges</h2>
                <p class="mb-0">All colleges in the system.</p>
            </div>
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="add-college.php" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="position-relative">
                            <span class="fw-normal" name='cname' id='cname'><?php echo($college['Name']) ?></span>
                        </td>
                        <td class="position-relative"><span class="fw-normal"><?php echo($college['DOS']) ?></span></td>                        
                        <td class="position-relative"><span class="fw-normal"><?php echo($college['Adress']) ?></span></td>
                    </tr>
                    <?php }?>
                    <!-- Item -->
