    ...
    <main class="content">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
            <div class="d-block mb-4 mb-md-0">
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                    <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                        ...
                        <li class="breadcrumb-item"><a href="home.php">Books</a></li>
            ...
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="Request.php" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="position-relative">
                            <span class="fw-normal"><?php echo $Book['Title'] ?></span>
                        </td>
                        <td class="position-relative">
                            <span class="fw-normal"><?php echo $Book['Publish-date'] ?></span>
                        </td>
