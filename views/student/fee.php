            ...
            <div class="d-block mb-4 mb-md-0">
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                    <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                        ...
                        <li class="breadcrumb-item"><a href="home.php">Payment</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Fee</li>
                    </ol>
                </nav>
                <h2 class="h4">Fee Details</h2>
            </div>
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="mypay.php" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
                    My payments
                </a>
            </div>
        </div>
