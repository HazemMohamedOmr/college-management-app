...
<!-- Primary Meta Tags -->
<title>Learnigo || Add Result</title>
    ...
    <main class="content">
        ...
        <div class="card card-body border-0 shadow table-wrapper table-responsive">
            <table class="table table-hover">
                <thead>
                    <tr>
                        <th class="border-gray-200">Teacher Name</th>					
                        <th class="border-gray-200">Description</th>
                        <th class="border-gray-200">Path</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <div>
                            <label for="college_name">Path</label>
                       
                            <input class="form-control" id="S_id" type="text" placeholder="Enter File Path" required>
                        
                        </div>
                    </div>
                    <button class="btn btn btn-danger btn-in-td" type="button" id="save">save</button>
                        </td>
