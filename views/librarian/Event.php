    ...
    <main class="content">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
            <div class="d-block mb-4 mb-md-0">
                ...
                <p class="mb-0">All Events in the system.</p>
            </div>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <span class="fw-normal"><?php echo $event['Name'] ?></span>
                        </td>
                        <td class="position-relative">
                        <span class="fw-normal"><?php echo $event['place'] ?></span>
                        </td>   
                        <td class="position-relative"><span class="fw-normal"><?php echo $event['description'] ?></span></td>                        
                        <td class="position-relative"><span class="fw-normal"><?php echo $event['date'] ?></span></td>
                        <td class="position-relative"><span class="fw-normal"><?php echo $event['time'] ?></span></td>       
                    </tr>
                    <?php }?>
                    <!-- Item -->
