                ...
                <div class="row align-items-center">
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control" name="Start-Date" id="Start-Date" type="date" placeholder="dd/mm/yyyy" required>                                               
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input class="form-control" name="End-Date" id="End-Date" type="date" placeholder="dd/mm/yyyy" required>                                               
                            </div>
                    </div>
