    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      ...
      <li class="nav-item">
        <span
          ...
          <span>
            ...
            <span class="sidebar-text">Dropdown page</span>
          </span>
          ...
          <ul class="flex-column nav">
            <li class="nav-item ">
              <a class="nav-link" href="../../pages/tables/bootstrap-tables.html">
                <span class="sidebar-text">dorpdown element</span>
              </a>
            </li>
          </ul>
        </div>
      ...
      <li class="nav-item">
        <a href="https://themesberg.com/docs/volt-bootstrap-5-dashboard/getting-started/quick-start/" target="_blank"
          ...
          <span class="sidebar-text">page 2 <span class="badge badge-sm bg-secondary ms-1 text-gray-800">txt</span></span>
        </a>
      </li>
    </ul>
  </div>
