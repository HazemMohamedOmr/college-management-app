...
<!-- Primary Meta Tags -->
<title>Learnigo || Issued Books</title>
            ...
            <div class="d-block mb-4 mb-md-0">
                <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                    <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                        ...
                        <li class="breadcrumb-item"><a href="home.php">Librarian</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Issued Books</li>
                    </ol>
                </nav>
                <h2 class="h4">All Book Issues </h2>
                <p class="mb-0">All Book Issues in the system.</p>
            </div>
            <div class="btn-toolbar mb-2 mb-md-0">
                <a href="IssueBook.php" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="border-gray-200">Librarian ID</th>						
